export default function Projects() {
  return (
    <section className="relative -z-10 min-h-screen rounded-b-3xl bg-background_second px-16 py-8">
      ...
      <div className="space-y-1">
        <span className="font-mono text-xl font-light text-muted">{`// WHAT I'VE BUILT?`}</span>
